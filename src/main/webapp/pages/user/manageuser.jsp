    ...
    <table border="5">
            ...
            <c:if test="${user.roleId!='1'}">
                <tr>
                    ...
                    <td><input type="button" name="del" value="删除用户数据"
                               onclick="javascrtpt:window.location.href='/deluser/${user.uname}'"></td>
                    <td><input type="button" name="change" value="修改用户数据"
                               onclick="javascrtpt:window.location.href='/befupduser/${user.uname}'"></td>
                </tr>
            </c:if>
        </c:forEach>
        </tr>
        <tr>
            <td><input type="button" name="alert" value="增加新用户"
                       onclick="javascrtpt:window.location.href='/getroles2'"></td>
        </tr>
    </table>
    <br/>
    <br/>
